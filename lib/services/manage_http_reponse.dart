...
void manageHttpResonse({
  required http.Response reponse, //the HTTP resonse from the request
  ...
  required VoidCallback onSuccess,//the callback to excute on a successfull response
    ...
    switch(reponse.statusCode) {
      case 200: //status code 200 indicates a successfull request
         onSuccess();
         break;
      case 400: //status code 200 indicates bad request
        showSnackBar(context, json.decode(reponse.body)['msg']);
        break;
      case 500: //status code 500 indicates a server error
        showSnackBar(context, json.decode(reponse.body)['error']);
        break;
