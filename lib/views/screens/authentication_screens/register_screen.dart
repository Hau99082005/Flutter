    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Text("Create Your Account", style: GoogleFonts.getFont(
            'Lato',  
            ...
            fontWeight: FontWeight.bold, letterSpacing: 0.2, fontSize: 25),), 
             ...
             Align(
              alignment: Alignment.topLeft,
              child: Text('Full Name', style: GoogleFonts.getFont('Nunito Sans',fontWeight: FontWeight.w600, letterSpacing: 0.2),
              ),
             ),
             TextFormField(
              onChanged: (value) {
              ...
              decoration: InputDecoration(
                ...
                prefixIcon: Padding(
                  padding: const EdgeInsets.all(10.0),
                  child: Image.asset('assets/icons/user.jpeg',width: 15, height: 15,),
